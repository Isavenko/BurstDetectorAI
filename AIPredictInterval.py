...
# This script tries to reverse engineer the current AI model to attempt to see where a burst appears inside a file.
# This method works with limited success, as currently, there is a problem with the model overfitting
...
model.load_weights("models\\magnumOpus.h5")
